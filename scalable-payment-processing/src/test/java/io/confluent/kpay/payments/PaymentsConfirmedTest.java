...
public class PaymentsConfirmedTest {
  ...
  public void singlePayment() throws Exception {
    ...
    String confirmed = "payments.confirmed";

    PaymentsConfirmed confirmed1 = new PaymentsConfirmed(complete, confirmed, getProperties("localhost:9091"));
    confirmed1.start();

    Topology topology = confirmed1.getTopology();
    ...
    System.out.println("Confirmed Records:" + inflightRecord.value());
