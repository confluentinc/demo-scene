...
_Stay tuned for the second part of this series, in which we dive into KSQL internals, and look at tools we can use for monitoring and examining the behaviour of running queries and KSQL itself._