...
* Windows: two options: 
  1. http://chocolately.org/docs/installation[Install choco] and then run `choco install jq`
  2. Download from https://stedolan.github.io/jq/download/[the official `jq` website] and add to Path 
