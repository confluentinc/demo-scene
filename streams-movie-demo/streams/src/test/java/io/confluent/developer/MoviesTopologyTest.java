...
import static io.confluent.developer.fixture.MoviesAndRatingsData.*;
...
public class MoviesTopologyTest {
  ...
  public void setUp() {
    ...
    SpecificAvroSerde<Movie> movieSerde = StreamsDemo.getSpecificAvroSerde(streamsConfig);
