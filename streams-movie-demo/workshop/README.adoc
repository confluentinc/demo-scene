...
If you need to troubleshoot what is going on with a particular service, you can use the `docker-compose logs -f <SERVICE>` command. For instance, the example below shows how to access the logs from Control Center:
