...
If you look to the KSQL query being executed, you should see tons of records being shown. Not only this proves that you are in the right track with this workshop but it also proves how KSQL is awesome. Think for a second what just happened:
