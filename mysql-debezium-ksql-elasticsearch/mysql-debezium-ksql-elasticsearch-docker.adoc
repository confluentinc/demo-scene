...
Import dashboard, from http://localhost:5601/app/kibana#/management/kibana/objects?_g=()&_a=(tab:dashboards)
...
* Load Kibana dashboard: http://localhost:5601/app/kibana#/
