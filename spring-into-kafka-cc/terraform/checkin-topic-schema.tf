resource "confluent_kafka_topic" "checkin" {
  kafka_cluster {
    id = confluent_kafka_cluster.kafka_cluster.id
  }

  topic_name = "checkin-avro"
...
resource "confluent_subject_config" "checkin_value_cfg" {
  subject_name = "${confluent_kafka_topic.checkin.topic_name}-value"
