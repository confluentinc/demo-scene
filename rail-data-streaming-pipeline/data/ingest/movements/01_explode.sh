...
#
# $ kafkacat -b broker:29092 -t networkrail_TRAIN_MVT -o end -C
...
kafkacat -b broker:29092 -u -G tm_explode networkrail_TRAIN_MVT  | \
 jq -c '.text|fromjson[]' | \
 kafkacat -b broker:29092 -t networkrail_TRAIN_MVT_X -P -T"
