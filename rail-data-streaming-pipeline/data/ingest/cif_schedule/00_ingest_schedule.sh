...
curl -s -L -u "$NROD_USERNAME:$NROD_PASSWORD" "https://datafeeds.networkrail.co.uk/ntrod/CifFileAuthenticate?type=CIF_EA_TOC_FULL_DAILY&day=toc-full" | \
  gunzip | \
  docker exec -i kafkacat kafkacat -b broker:29092 -P -t CIF_FULL_DAILY
...
#   gunzip | \
#   grep JsonScheduleV1 | \
#   kafkacat -b broker:29092 -P -t CIF_EA_TOC_FULL_DAILY_JsonScheduleV1

# curl -s -L -u "NROD_USERNAME:NROD_PASSWORD" "https://datafeeds.networkrail.co.uk/ntrod/CifFileAuthenticate?type=CIF_EA_TOC_FULL_DAILY&day=toc-full" | \
#   gunzip | \
#   grep TiplocV1 | \
#   kafkacat -b broker:29092 -P -t CIF_EA_TOC_FULL_DAILY_TiplocV1
