...
docker-compose exec kafka kafka-topics --zookeeper zookeeper:2181 --delete --topic TRAIN_MOVEMENTS_ACTIVATIONS_SCHEDULE_03
...
curl -X DELETE http://proxmox01.moffatt.me:8081/subjects/TRAIN_MOVEMENTS_ACTIVATIONS_SCHEDULE_01-value
curl -X DELETE http://proxmox01.moffatt.me:8081/subjects/TRAIN_MOVEMENTS_ACTIVATIONS_SCHEDULE_03-value
