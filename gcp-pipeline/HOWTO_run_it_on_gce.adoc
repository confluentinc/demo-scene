...
[source,bash]
----
export SCHEMA_REGISTRY_HOST=35.237.252.210
----
...
[source,bash]
----
export KSQL_SERVER_HOST=35.231.210.79
----
...
[source,bash]
----
export CONNECT_HOST_SOURCE=35.237.247.88
----
...
[source,bash]
----
export CONNECT_HOST_SINK=35.231.210.79
----
